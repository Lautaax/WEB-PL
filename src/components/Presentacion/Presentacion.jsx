        ...
        <div className="col-md-8">
            ...
            <div className="row">
                <div className="col-md-6 separacion ">
                    <h3>Javier Milei, el reconocido economista liberal argentino, ha
                ...
                <div className="col-md-6 separacion"><h3>Javier Milei, el reconocido economista liberal argentino, ha
                    presentado su plan para llevar a cabo una verdadera transformación
                    económica en el país. Su enfoque se centra en acabar con el
                    socialismo que ha gobernado el país durante décadas, levantar la
                    economía, dolarizar y terminar con los planes sociales y la deuda
                ...
                <div className="col-md-6 separacion">
                    <h3>El primer paso de Milei sería abolir las políticas socialistas y
                ...
                <div className="col-md-6 separacion">
                    <h3>Además, Milei propone dolarizar la economía, lo que significaría
                ...
                <div className="col-md-6 separacion">
                    <h3>Por último, Milei aborda el tema de los planes sociales y la deuda
                    ...
                    sostenible para evitar un default que haga colapsar la economía.</h3>
                    
                </div>
                <div className="col-md-6 separacion">
                    <h3>Javier Milei está convencido de que su plan es la única manera de
